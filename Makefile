...
pkgdatadir = $(datadir)/coinmegatrend
pkgincludedir = $(includedir)/coinmegatrend
pkglibdir = $(libdir)/coinmegatrend
pkglibexecdir = $(libexecdir)/coinmegatrend
...
CONFIG_HEADER = $(top_builddir)/src/config/coinmegatrend-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/coinmegatrend-config.h.in \
...
ACLOCAL = ${SHELL} /Users/vishalsachdeva/Desktop/CMTR/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /Users/vishalsachdeva/Desktop/CMTR/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/vishalsachdeva/Desktop/CMTR/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /Users/vishalsachdeva/Desktop/CMTR/build-aux/missing automake-1.16
AWK = awk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = coinmegatrend-cli
BITCOIN_DAEMON_NAME = coinmegatrendd
BITCOIN_GUI_NAME = coinmegatrend-qt
BITCOIN_TX_NAME = coinmegatrend-tx
...
MAINT = 
MAKEINFO = ${SHELL} /Users/vishalsachdeva/Desktop/CMTR/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL = otool
OTOOL64 = :
PACKAGE = coinmegatrend
PACKAGE_BUGREPORT = www.coinmegatrend.org
PACKAGE_NAME = coinmegatrend Core
PACKAGE_STRING = coinmegatrend Core 1.0.0
PACKAGE_TARNAME = coinmegatrend
PACKAGE_URL = 
...
abs_builddir = /Users/vishalsachdeva/Desktop/CMTR
abs_srcdir = /Users/vishalsachdeva/Desktop/CMTR
abs_top_builddir = /Users/vishalsachdeva/Desktop/CMTR
abs_top_srcdir = /Users/vishalsachdeva/Desktop/CMTR
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/vishalsachdeva/Desktop/CMTR/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_coinmegatrend_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_coinmegatrend_coverage.info test_coinmegatrend.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/coinmegatrend-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/coinmegatrend-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/coinmegatrend-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/coinmegatrend-config.h
$(top_srcdir)/src/config/coinmegatrend-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/coinmegatrend-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/coinmegatrend-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
#$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/coinmegatrend-Qt
...
#$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/coinmegatrend-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_coinmegatrend.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_coinmegatrend -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_coinmegatrend_filtered.info: test_coinmegatrend.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_coinmegatrend_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_coinmegatrend_coverage.info: baseline_filtered_combined.info test_coinmegatrend_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_coinmegatrend_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_coinmegatrend_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_coinmegatrend_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_coinmegatrend.coverage/.dirstamp:  test_coinmegatrend_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_coinmegatrend.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_coinmegatrend.coverage/ total.coverage/ $(OSX_APP)
