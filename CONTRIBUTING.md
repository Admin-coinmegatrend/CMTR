Contributing to coinmegatrend Core
============================

The coinmegatrend Core project operates an open contributor model where anyone is
...
The following applies to code changes to the coinmegatrend Core project, and is not to be
confused with overall coinmegatrend Network Protocol consensus changes.

Whether a pull request is merged into coinmegatrend Core rests with the project merge
...
Patches that change coinmegatrend consensus rules are considerably more involved than
...
Where a patch set proposes to change the coinmegatrend consensus, it must have been
...
The project leader is the release manager for each coinmegatrend Core release.
