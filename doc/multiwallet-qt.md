...
In order to support loading of multiple wallets in coinmegatrend-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is coinmegatrend.cpp.
...
Changes to coinmegatrend.cpp
----------------------
coinmegatrend.cpp is the entry point into coinmegatrend-qt, and as such, will require some minor modifications to provide hooks for
