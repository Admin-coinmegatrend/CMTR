/* src/config/coinmegatrend-config.h.  Generated from coinmegatrend-config.h.in by configure.  */
/* src/config/coinmegatrend-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef coinmegatrend_CONFIG_H

#define coinmegatrend_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.coinmegatrend.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "coinmegatrend Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "coinmegatrend Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "coinmegatrend"
