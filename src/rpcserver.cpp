...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop coinmegatrend server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "coinmegatrend server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* coinmegatrend features */
        {"coinmegatrend", "masternode", &masternode, true, true, false},
        {"coinmegatrend", "listmasternodes", &listmasternodes, true, true, false},
        {"coinmegatrend", "getmasternodecount", &getmasternodecount, true, true, false},
        {"coinmegatrend", "masternodeconnect", &masternodeconnect, true, true, false},
        {"coinmegatrend", "masternodecurrent", &masternodecurrent, true, true, false},
        {"coinmegatrend", "masternodedebug", &masternodedebug, true, true, false},
        {"coinmegatrend", "startmasternode", &startmasternode, true, true, false},
        {"coinmegatrend", "createmasternodekey", &createmasternodekey, true, true, false},
        {"coinmegatrend", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"coinmegatrend", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"coinmegatrend", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"coinmegatrend", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"coinmegatrend", "getmasternodescores", &getmasternodescores, true, true, false},
        {"coinmegatrend", "mnbudget", &mnbudget, true, true, false},
        {"coinmegatrend", "preparebudget", &preparebudget, true, true, false},
        {"coinmegatrend", "submitbudget", &submitbudget, true, true, false},
        {"coinmegatrend", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"coinmegatrend", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"coinmegatrend", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"coinmegatrend", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"coinmegatrend", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"coinmegatrend", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"coinmegatrend", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"coinmegatrend", "checkbudgets", &checkbudgets, true, true, false},
        {"coinmegatrend", "mnsync", &mnsync, true, true, false},
        {"coinmegatrend", "spork", &spork, true, true, false},
        {"coinmegatrend", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"coinmegatrend", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use coinmegatrendd, or the -server option to coinmegatrend-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> coinmegatrend-cli " + methodname + " " + args + "\n";
}
