...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000e8f7301fc905cdb76444eddc5499db04dca25c87ce38b415710e4a9e73f"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1552383398, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("0440fc731a6c2a27fa35b904059ff5c06e2c6663539e064faf62fca57c12ebb651f57bdef77517ccaa59d0acd65161a26f9cbd2f0523404f146c4852f3d05ae4c1");
        nDefaultPort = 16031;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 coinmegatrend starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 30; // coinmegatrend: 0.5 minutes
        nTargetSpacingSlowLaunch = 10 * 60;  // coinmegatrend: 10 minutes (Slow launch - Block 288)
        nTargetSpacing = 1 * 60;  // coinmegatrend: 60 Seconds
        nMaturity = 19;
         ...
         */
        const char* pszTimestamp = "coinmegatrend new blockchain is here";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04f2da3f032d0d2656d6210b3820310a9ab35738e172af5d68d9d42dcb67759d104a6b2beabe2dcb729613f34f82d6cca70f0f27a405df45dfd0f56254a975f5cc") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1552383398;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 4599872;

        hashGenesisBlock = uint256("0x00000e8f7301fc905cdb76444eddc5499db04dca25c87ce38b415710e4a9e73f");
        ...
        assert(hashGenesisBlock == uint256("0x00000e8f7301fc905cdb76444eddc5499db04dca25c87ce38b415710e4a9e73f"));
        assert(genesis.hashMerkleRoot == uint256("0xf044cfc700955c9880e4fec3938264a563229f441202f2fbe2c136e18d970ad5"));
        ...
        vSeeds.push_back(CDNSSeedData("144.202.27.195", "144.202.27.195"));
	vSeeds.push_back(CDNSSeedData("207.148.96.94", "207.148.96.94"));
        ...
        //strSporkKey = "0459eede7626441f7802af2736cb3a4aeb3e1f95070cde39d068a4f16525ee8fdd3c075f29f9e115aeb91952239194aa6ac19765574fed8a0d7f174f2b450e9630";
		    strSporkKey = "04249245BDC0028BAADB001DEE04A130575E3F5371E8C49696C6322E8D5A7AE7B6878432BF95EAC225D30B6DCC667414F95A274A340BBA202F45A0391E3EB656BA";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // coinmegatrend: 1 day
        nTargetSpacing = 1 * 60;  // coinmegatrend: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet coinmegatrend addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet coinmegatrend script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet coinmegatrend BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet coinmegatrend BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet coinmegatrend BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // coinmegatrend: 1 day
        nTargetSpacing = 1 * 60;        // coinmegatrend: 1 minutes
