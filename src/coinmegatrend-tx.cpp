...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("coinmegatrend Core coinmegatrend-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  coinmegatrend-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded coinmegatrend transaction") + "\n" +
                               "  coinmegatrend-tx [options] -create [commands]   " + _("Create hex-encoded coinmegatrend transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded coinmegatrend transaction
