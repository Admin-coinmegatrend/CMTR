...
public:
    ...
    void setZcoinmegatrendControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzcmtr_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzcmtr_clicked();
    void on_pushButtonZcoinmegatrendControl_clicked();
