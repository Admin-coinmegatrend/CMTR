...
/** Utility functions used by the coinmegatrend Qt UI.
 */
namespace GUIUtil
{
...
// Render coinmegatrend addresses in monospace font
...
// Parse "coinmegatrend:" URI into recipient object, return true on successful parsing
