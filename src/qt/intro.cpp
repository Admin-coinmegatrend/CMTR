...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("coinmegatrend Core"),
     ...
     * override -datadir in the coinmegatrend.conf file in the default data directory
     * (to be consistent with coinmegatrendd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
