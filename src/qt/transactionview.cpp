                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received coinmegatrend from zcmtr"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zcmtr"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zcmtr));
