...
QString BitcoinUnits::id(int unit)
{
    ...
    case coinmegatrend:
        return QString("CMTR");
    case msnd:
        return QString("mcmtr");
    case usnd:
        return QString::fromUtf8("ucmtr");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        switch (unit) {
        case coinmegatrend:
            return QString("tcmtr");
        case msnd:
            return QString("mtcmtr");
        case usnd:
            return QString::fromUtf8("μtcmtr");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case coinmegatrend:
            return QString("coinmegatrend");
        case msnd:
            return QString("Milli-coinmegatrend (1 / 1" THIN_SP_UTF8 "000)");
        case usnd:
            return QString("Micro-coinmegatrend (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
