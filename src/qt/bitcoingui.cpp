                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("coinmegatrend Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a coinmegatrend address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and coinmegatrend: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zcmtr"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About coinmegatrend Core"), this);
    aboutAction->setStatusTip(tr("Show information about coinmegatrend Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for coinmegatrend"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your coinmegatrend addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified coinmegatrend addresses"));
    ...
    openAction->setStatusTip(tr("Open a coinmegatrend: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the coinmegatrend Core help message to get a list with possible coinmegatrend command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("coinmegatrend Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to coinmegatrend network", "", count));
}
...
{
    QString strTitle = tr("coinmegatrend Core"); // default title
...
/** Creates context menu, its actions, and coinmegatrends up all the relevant signals for mouse events. */
