...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted coinmegatrend to zcmtr");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zcmtr");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received coinmegatrend from zcmtr");
    case TransactionRecord::ZerocoinSpend_Change_zcmtr:
        return tr("Minted Change as zcmtr from zcmtr Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zcmtr to coinmegatrend");
